...
import { H3, Body1, Body3 } from "../../../../assets/styles/Typography";
...
const PagePersona3Multiple = () => {
  ...
  const [, setSelectedInterviewType] = useAtom(SELECTED_INTERVIEW_TYPE);
  ...
  useEffect(() => {
    ...
    const detectRefresh = () => {
      ...
      if (currentUrl.toLowerCase().includes("persona3multiple")) {
      ...
      >
        ...
        <MainContent Wide1030>
          <PersonaSingleWrap>
            ...
            <TabContent5>
              <div className="title">
                <H3 color="gray800">Discussion Topic Define</H3>
                <Body3 color="gray800">
                  그룹 인터뷰에서 다양한 페르소나와 토론할 주제를 선정하세요
                </Body3>
              </div>
...
export default PagePersona3Multiple;
